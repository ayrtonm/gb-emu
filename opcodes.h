...
case 0x2f:  {TOGGLE(0xFF,_A);SET(N_FLAG|H_FLAG,_F);break;}
...
case 0x37:  {SET(C_FLAG,_F);CLEAR(N_FLAG|H_FLAG,_F);break;}
...
case 0x3f:  {TOGGLE(C_FLAG,_F);CLEAR(N_FLAG|H_FLAG,_F);break;}
