...
case 0x20:  {COND_JR((ZERO==0),IMM8);break;}
...
case 0x27:  {DAA;break;}
case 0x28:  {COND_JR((ZERO==1),IMM8);break;}
...
case 0x30:  {COND_JR((CARRY==0),IMM8);break;}
...
case 0xc2:  {COND_JP((ZERO==0),IMM16);break;}
case 0xc3:  {JP(IMM16);break;}
case 0xc4:  {COND_CALL((ZERO==0),IMM16);break;}
case 0xc5:  {PUSH(_B,_C);break;}
case 0xc6:  {ADD(IMM8);break;}
case 0xc7:  {RST(0x00);break;}
case 0xc8:  {COND_RET((ZERO==1));break;}
...
case 0xd0:  {COND_RET((CARRY==0));break;}
case 0xd1:  {POP(_D,_E);break;}
case 0xd2:  {COND_JP((CARRY==0),IMM16);break;}
case 0xd3:  {break;}//no opcode
case 0xd4:  {COND_CALL((CARRY==0),IMM16);break;}
case 0xd5:  {PUSH(_D,_E);break;}
case 0xd6:  {SUB(IMM8);break;}
case 0xd7:  {RST(0x10);break;}
case 0xd8:  {COND_RET((CARRY==1));break;}

case 0xd9:  {RETI;break;}
case 0xda:  {COND_JP((CARRY==1),IMM16);break;}
case 0xdb:  {break;}//no opcode
case 0xdc:  {COND_CALL((CARRY==1),IMM16);break;}
...
case 0xe8:  {int mtemp = _SP + ((signed char)IMM8);_F = (mtemp & 0x0100 ? C_FLAG : 0)|(_HL^(IMM8)^(mtemp & 0xFFFF) & 0x10 ? H_FLAG : 0);_SP = mtemp & 0xFFFF;break;}//add sp, r8
...
case 0xf3:  {_IME=0;EI_DELAY = 0;break;}
