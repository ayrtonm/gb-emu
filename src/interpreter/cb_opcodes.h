...
case 0x6:  {uint8_t temp = m.read_byte(hl.w);RLC(temp);m.write_byte(hl.w,temp);break;}
...
case 0xe:  {uint8_t temp = m.read_byte(hl.w);RRC(temp);m.write_byte(hl.w,temp);break;}
...
case 0x16:  {uint8_t temp = m.read_byte(hl.w);RL(temp);m.write_byte(hl.w,temp);break;}
...
case 0x1e:  {uint8_t temp = m.read_byte(hl.w);RR(temp);m.write_byte(hl.w,temp);break;}
...
case 0x26:  {uint8_t temp = m.read_byte(hl.w);SLA(temp);m.write_byte(hl.w,temp);break;}
...
case 0x2e:  {uint8_t temp = m.read_byte(hl.w);SRA(temp);m.write_byte(hl.w,temp);break;}
...
case 0x36:  {uint8_t temp = m.read_byte(hl.w);CB_SWAP(temp);m.write_byte(hl.w,temp);break;}
...
case 0x3e:  {uint8_t temp = m.read_byte(hl.w);SRL(temp);m.write_byte(hl.w,temp);break;}
...
case 0x86:  {uint8_t temp = m.read_byte(hl.w);CLEAR(0x1,temp);m.write_byte(hl.w,temp);break;}
...
case 0x8E:  {uint8_t temp = m.read_byte(hl.w);CLEAR(0x2,temp);m.write_byte(hl.w,temp);break;}
...
case 0x96:  {uint8_t temp = m.read_byte(hl.w);CLEAR(0x4,temp);m.write_byte(hl.w,temp);break;}
...
case 0x9E:  {uint8_t temp = m.read_byte(hl.w);CLEAR(0x8,temp);m.write_byte(hl.w,temp);break;}
...
case 0xa6:  {uint8_t temp = m.read_byte(hl.w);CLEAR(0x10,temp);m.write_byte(hl.w,temp);break;}
...
case 0xaE:  {uint8_t temp = m.read_byte(hl.w);CLEAR(0x20,temp);m.write_byte(hl.w,temp);break;}
...
case 0xb6:  {uint8_t temp = m.read_byte(hl.w);CLEAR(0x40,temp);m.write_byte(hl.w,temp);break;}
...
case 0xbE:  {uint8_t temp = m.read_byte(hl.w);CLEAR(0x80,temp);m.write_byte(hl.w,temp);break;}
...
case 0xc6:  {uint8_t temp = m.read_byte(hl.w);SET(0x1,temp);m.write_byte(hl.w,temp);break;}
...
case 0xcE:  {uint8_t temp = m.read_byte(hl.w);SET(0x2,temp);m.write_byte(hl.w,temp);break;}
...
case 0xd6:  {uint8_t temp = m.read_byte(hl.w);SET(0x4,temp);m.write_byte(hl.w,temp);break;}
...
case 0xdE:  {uint8_t temp = m.read_byte(hl.w);SET(0x8,temp);m.write_byte(hl.w,temp);break;}
...
case 0xe6:  {uint8_t temp = m.read_byte(hl.w);SET(0x10,temp);m.write_byte(hl.w,temp);break;}
...
case 0xeE:  {uint8_t temp = m.read_byte(hl.w);SET(0x20,temp);m.write_byte(hl.w,temp);break;}
...
case 0xf6:  {uint8_t temp = m.read_byte(hl.w);SET(0x40,temp);m.write_byte(hl.w,temp);break;}
...
case 0xfE:  {uint8_t temp = m.read_byte(hl.w);SET(0x80,temp);m.write_byte(hl.w,temp);break;}
